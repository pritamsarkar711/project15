...
<div id="previous-exceptions" class="flex flex-col gap-2.5 bg-neutral-50 dark:bg-white/1 border border-neutral-200 dark:border-neutral-800 p-2.5 shadow-xs">
    <div class="flex items-center gap-2.5 p-2">
        <div class="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-white/5 w-6 h-6 flex items-center justify-center p-1">
            ...
            <div class="flex gap-2.5 px-2">
                ...
                @if ($exception->previousExceptions()->count() > 1)
                    <div class="flex flex-col items-center w-6 flex-shrink-0 self-stretch">
                        ...
                        <div class="size-[9px] flex-shrink-0 bg-emerald-800"></div>
                ...
                <div
                    ...
                    class="group/exception flex-1 min-w-0 my-1.5"
                    :class="{
 ...
 @endif
                ...
                >
                    {{-- Header + Message --}}
                    <div
                        class="flex gap-2.5 p-3 cursor-pointer"
                    ...
                    >
                        ...
                        <button
                            type="button"
                            class="flex h-6 w-6 flex-shrink-0 cursor-pointer items-center justify-center border border-neutral-200 dark:border-white/8 group-hover/exception:text-blue-500 group-hover/exception:dark:text-emerald-500"
                            :class="{
