...
<div class="flex flex-col pt-8 sm:pt-16 overflow-x-auto">
    ...
    <div class="flex items-start gap-2 mb-8 sm:mb-16">
        <div class="bg-white dark:bg-white/[3%] border border-neutral-200 dark:border-white/10 divide-x divide-neutral-200 dark:divide-white/10 shadow-xs flex items-center gap-0.5">
