...
<div
    ...
    class="group border border-neutral-200 dark:border-white/5"
    :class="{
...
>
    <div
        class="flex h-11 cursor-pointer items-center gap-3 pr-2.5 pl-4 hover:bg-white/50 dark:hover:bg-white/2"
    ...
    >
        ...
        <button
            x-cloak
            type="button"
            class="flex h-6 w-6 cursor-pointer items-center justify-center dark:border dark:border-white/8 group-hover:text-blue-500 group-hover:dark:text-emerald-500"
            :class="{
