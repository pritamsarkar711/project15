...
>
    ...
    <div class="flex flex-col gap-1">
        ...
        <div
            class="border border-neutral-200 dark:border-none bg-white dark:bg-white/[3%] h-10 flex items-center justify-between gap-4 px-4 text-xs font-mono shadow-xs"
    ...
    <div x-cloak x-show="totalPages > 1" class="flex items-center justify-center gap-1 py-4 font-mono">
        ...
        <button
            @click="first()"
            class="cursor-pointer flex items-center justify-center w-8 h-8 transition-colors"
            ...
            <div>
                ...
                <template x-if="page.type === 'page'">
                    <button
                        ...
                        class="cursor-pointer flex items-center justify-center w-8 h-8 text-sm font-medium transition-colors"
