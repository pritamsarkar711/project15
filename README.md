...
- **Grouped admin sidebar**: the navigation rail organizes its sixteen links into four collapsible sections (Content, Engagement, People, System) with smooth open/close animation; the section holding the page you are on always opens, your open/closed preference is remembered across pages, and a collapsed section keeps its pending-count badge so nothing is silently hidden; the rail never shows a scrollbar, even on short screens
