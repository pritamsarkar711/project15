...
define('HUVANTI_DEPLOY_VERSION', 'v17-2026-08-25-css-rebuild-hero-badges');
...
function huvanti_render_boot_failure_page(?Throwable $e, array $notes = []): void
{
    if (!headers_sent()) {
        ...
        header('X-Huvanti-Deploy: 2026-08-25-ads-badges-editor-v16');
    }
    ...
    $checks = [
        'Deployment release' => [
            'ok' => true,
            'value' => '2026-08-25-ads-badges-editor-v16',
        ],
        'PHP version' => [
