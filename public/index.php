...
define('HUVANTI_DEPLOY_VERSION', 'v70-2026-09-03-faq-survives-approval');
...
try {
    ...
    if (trim($storedVersion) !== HUVANTI_DEPLOY_VERSION) {
        ...
        try {
            ...
            $legalUpdates = [
                "privacy-policy" => \App\Http\Controllers\Frontend\PageController::defaultContent("privacy-policy"),
                "terms-conditions" => \App\Http\Controllers\Frontend\PageController::defaultContent("terms-conditions"),
                "cookie-policy" => \App\Http\Controllers\Frontend\PageController::defaultContent("cookie-policy"),
                "editorial-policy" => \App\Http\Controllers\Frontend\PageController::defaultContent("editorial-policy"),
                "disclaimer" => \App\Http\Controllers\Frontend\PageController::defaultContent("disclaimer"),
                "about" => \App\Http\Controllers\Frontend\PageController::defaultContent("about"),
                "affiliate-disclosure" => \App\Http\Controllers\Frontend\PageController::defaultContent("affiliate-disclosure"),
                "comment-policy" => \App\Http\Controllers\Frontend\PageController::defaultContent("comment-policy"),
            ];
