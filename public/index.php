...
define('HUVANTI_DEPLOY_VERSION', 'v41-2026-08-25-adsense-pages');
            ...
            foreach ($legalUpdates as $slug => $content) {
                try {
                    ...
                    if ($existing) {
                        ...
                        if (strlen(strip_tags($old)) < 1200 || strpos($old, 'Last updated: August 2026') === false || strpos($old, 'infringes your copyright') === false) {
