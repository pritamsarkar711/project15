{{-- Standalone 404 page (fallback: 404s normally redirect home, this renders only in edge cases): intentionally does NOT extend any site layout so it
...
<head>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box}
        ...
        .icon{width:56px;height:56px;background:#f0fdf4;color:#0C3B2E;display:flex;align-items:center;justify-content:center;margin:0 auto 18px}
