{{-- Standalone 500 page: intentionally does NOT extend any site layout so it
...
<head>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box}
        ...
        .icon{width:56px;height:56px;background:#fef2f2;color:#dc2626;display:flex;align-items:center;justify-content:center;margin:0 auto 18px}
...
<body>
    <div class="box">
        <div class="icon">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>
        </div>
        <div class="code">Error 500</div>
        <h1>Something went wrong on our side</h1>
        <p>The server hit an unexpected problem while building this page. It has been logged and usually fixes itself after a short moment. Please try again.</p>
