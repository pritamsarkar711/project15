...
<div class="flex justify-between items-center mb-5">
    ...
    <a href="{{ route('admin.pages.create') }}" class="h-9 px-4 rounded-lg bg-[var(--brand)] hover:bg-[var(--brand-strong)] text-white text-sm font-semibold inline-flex items-center gap-1.5">
                    ...
                    <tr class="hover:bg-slate-50/70 dark:hover:bg-slate-800/40">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex justify-end gap-1">
                                ...
                                <a href="{{ route('admin.pages.edit', $page) }}" title="Edit" class="w-8 h-8 rounded-lg bg-[var(--brand)] hover:bg-[var(--brand-strong)] text-white flex items-center justify-center">
