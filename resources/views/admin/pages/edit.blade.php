    ...
    <div class="lg:col-span-8">
        <form id="page-form" method="POST" action="{{ route('admin.pages.update', $page) }}" class="panel-card p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="title" required value="{{ old('title', $page->title) }}" class="mt-1 w-full h-11 px-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm outline-none">
            </div>
            ...
            <div class="flex gap-2">
                <button type="submit" class="h-11 px-6 rounded-lg bg-[var(--brand)] hover:bg-[var(--brand-strong)] text-white font-semibold transition">Update Page</button>
