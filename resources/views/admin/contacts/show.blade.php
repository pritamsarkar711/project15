...
<div class="w-full">
    <div class="flex items-center gap-3 mb-5">
        ...
        <h2 class="font-semibold truncate min-w-0">Message from {{ $contact->name }}</h2>
    </div>
    ...
    <div class="panel-card p-6">
        ...
        <div class="mt-6 flex flex-wrap gap-2">
            <a href="mailto:{{ $contact->email }}?subject=Re: {{ $contact->subject ?? $contact->reason }}" class="h-10 px-5 rounded-lg bg-[var(--brand)] hover:bg-[var(--brand-strong)] text-white text-sm font-semibold inline-flex items-center gap-2 transition">
