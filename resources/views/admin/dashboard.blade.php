...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
    <div class="stat-card">
        ...
        <a href="{{ route('admin.posts.index') }}" class="mt-2 inline-flex text-xs font-semibold text-[var(--brand)] dark:text-[var(--brand-light)] hover:underline underline-offset-4">Manage posts</a>
    </div>
    <div class="stat-card">
        <div class="flex items-center justify-between">
    ...
    <div class="stat-card">
        ...
        <a href="{{ route('admin.comments.index',['status'=>'pending']) }}" class="mt-2 inline-flex text-xs font-semibold text-[var(--brand)] dark:text-[var(--brand-light)] hover:underline underline-offset-4">Moderate</a>
    </div>
    <div class="stat-card">
        <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.contacts.index',['filter'=>'unread']) }}" class="mt-2 inline-flex text-xs font-semibold text-[var(--brand)] dark:text-[var(--brand-light)] hover:underline underline-offset-4">Open inbox</a>
    </div>
</div>
    ...
    <div class="lg:col-span-2 space-y-5">
        <div class="panel-card p-5">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.posts.index') }}" class="text-xs font-semibold text-[var(--brand)] dark:text-[var(--brand-light)] hover:underline underline-offset-4">View all</a>
            </div>
            <div class="divide-y divide-[#eef0f4] dark:divide-[#22262e]">
                @forelse($recentPosts as $post)
                    <div class="flex items-center gap-3 py-3">
                        ...
                        @else
                            <div class="w-11 h-11 rounded-lg bg-[var(--brand-tint)] dark:bg-[var(--brand)]/10 text-[var(--brand)] dark:text-[var(--brand-light)] flex items-center justify-center">
                        ...
                        <div class="flex-1 min-w-0">
                            <a href="{{ route('admin.posts.edit',$post) }}" class="text-sm font-semibold truncate block hover:text-[var(--brand)] dark:hover:text-[var(--brand-light)]">{{ $post->title }}</a>
        ...
        <div class="panel-card p-5">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.comments.index') }}" class="text-xs font-semibold text-[var(--brand-ink)] dark:text-[var(--brand-light)] hover:underline">View all</a>
            </div>
    ...
    <div class="space-y-5">
        <div class="panel-card p-5">
            ...
            <div class="mt-4 grid grid-cols-2 gap-2.5">
                <a href="{{ route('admin.posts.create') }}" class="group flex flex-col items-start gap-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/60 dark:bg-slate-800/40 p-3.5 hover:border-[var(--brand)]/50 hover:bg-white dark:hover:bg-slate-800 transition">
                    <span class="icon-tile w-8 h-8 rounded-lg">
                ...
                <a href="{{ route('admin.categories.create') }}" class="group flex flex-col items-start gap-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/60 dark:bg-slate-800/40 p-3.5 hover:border-[var(--brand)]/50 hover:bg-white dark:hover:bg-slate-800 transition">
                    <span class="icon-tile w-8 h-8 rounded-lg">
                    ...
                    <span class="text-sm font-semibold text-slate-700 dark:text-slate-200 group-hover:text-[var(--brand-strong)] dark:group-hover:text-[var(--brand-light)] transition">New Category</span>
                </a>
                <a href="{{ route('admin.settings.index') }}" class="group flex flex-col items-start gap-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/60 dark:bg-slate-800/40 p-3.5 hover:border-[var(--brand)]/50 hover:bg-white dark:hover:bg-slate-800 transition">
                    <span class="icon-tile w-8 h-8 rounded-lg">
                    ...
                    <span class="text-sm font-semibold text-slate-700 dark:text-slate-200 group-hover:text-[var(--brand-strong)] dark:group-hover:text-[var(--brand-light)] transition">Settings</span>
                </a>
                <a href="{{ route('admin.profile.edit') }}" class="group flex flex-col items-start gap-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/60 dark:bg-slate-800/40 p-3.5 hover:border-[var(--brand)]/50 hover:bg-white dark:hover:bg-slate-800 transition">
                    <span class="icon-tile w-8 h-8 rounded-lg">
        ...
        <div class="panel-card p-5">
            ...
            <div class="mt-3 space-y-1.5 text-sm">
                <a href="{{ route('admin.social.index') }}" class="flex items-center gap-2.5 px-2 py-2 -mx-2 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-[#f2f4f8] dark:hover:bg-[#1c1f26] hover:text-[#101319] dark:hover:text-white transition">
                    <svg class="w-4 h-4 shrink-0 text-[var(--brand)] dark:text-[var(--brand-light)]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><path stroke-linecap="round" stroke-linejoin="round" d="m8.59 13.51 6.83 3.98m-.01-10.98-6.82 3.98"/></svg>
                    Social Auto-Post
                </a>
                ...
                <a href="{{ route('admin.settings.index', ['tab' => 'integrations']) }}" class="flex items-center gap-2.5 px-2 py-2 -mx-2 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-[#f2f4f8] dark:hover:bg-[#1c1f26] hover:text-[#101319] dark:hover:text-white transition">
                    <svg class="w-4 h-4 shrink-0 text-[var(--brand)] dark:text-[var(--brand-light)]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 19.5v-15m0 0-6.75 6.75M12 4.5l6.75 6.75"/></svg>
                    Instant Indexing
                </a>
            </div>
        </div>
