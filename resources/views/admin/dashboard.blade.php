...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
    <div class="stat-card">
        ...
        <a href="{{ route('admin.posts.index') }}" class="mt-2 inline-flex text-xs font-semibold text-[#047a43] dark:text-emerald-300 hover:underline underline-offset-4">Manage posts</a>
    </div>
    <div class="stat-card">
        <div class="flex items-center justify-between">
    ...
    <div class="stat-card">
        ...
        <a href="{{ route('admin.comments.index',['status'=>'pending']) }}" class="mt-2 inline-flex text-xs font-semibold text-[#047a43] dark:text-emerald-300 hover:underline underline-offset-4">Moderate</a>
    </div>
    <div class="stat-card">
        <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.contacts.index',['filter'=>'unread']) }}" class="mt-2 inline-flex text-xs font-semibold text-[#047a43] dark:text-emerald-300 hover:underline underline-offset-4">Open inbox</a>
    </div>
</div>
    ...
    <div class="lg:col-span-2 space-y-5">
        <div class="panel-card p-5">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.posts.index') }}" class="text-xs font-semibold text-[#047a43] dark:text-emerald-300 hover:underline underline-offset-4">View all</a>
            </div>
            <div class="divide-y divide-[#eef0f4] dark:divide-[#22262e]">
                @forelse($recentPosts as $post)
                    <div class="flex items-center gap-3 py-3">
                        ...
                        @else
                            <div class="w-11 h-11 rounded-lg bg-[#E8F8F0] dark:bg-emerald-500/10 text-[#047a43] dark:text-emerald-300 flex items-center justify-center">
                        ...
                        <div class="flex-1 min-w-0">
                            <a href="{{ route('admin.posts.edit',$post) }}" class="text-sm font-semibold truncate block hover:text-[#047a43] dark:hover:text-emerald-300">{{ $post->title }}</a>
