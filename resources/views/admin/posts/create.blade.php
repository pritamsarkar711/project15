    ...
    <div class="grid lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-4 space-y-5">
            <div class="panel-card p-6">
                ...
                <label class="flex items-center gap-2 mt-3 text-sm"><input type="checkbox" name="is_featured" value="1" class="border-slate-300 dark:border-slate-600 text-[var(--brand-strong)]"> Featured post</label>
                <label class="flex items-center gap-2 mt-2 text-sm"><input type="checkbox" name="allow_comments" value="1" checked class="border-slate-300 dark:border-slate-600 text-[var(--brand-strong)]"> Allow comments</label>
                <button type="submit" class="w-full mt-4 h-11 rounded-lg bg-[var(--brand)] hover:bg-[var(--brand-strong)] text-white font-semibold transition">Create Post</button>
