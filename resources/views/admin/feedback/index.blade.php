                    ...
                    <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                        @foreach($feedbacks as $fb)
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                ...
                                <td class="px-4 py-3"><span class="px-2 py-1 bg-[var(--brand-tint-3)] dark:bg-[var(--brand-mid)]/10 text-[var(--brand-ink)] dark:text-[var(--brand-light)] text-xs font-medium">{{ $fb->overall_experience }}</span></td>
                                ...
                                <td class="px-4 py-3 text-right"><a href="{{ route('admin.feedback.show', $fb) }}" class="text-[var(--brand-ink)] dark:text-[var(--brand-light)] hover:underline text-xs font-semibold">View</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
