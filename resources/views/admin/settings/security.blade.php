...
<div class="w-full">
    <div class="panel-card p-6">
        ...
        @elseif($user->google2fa_secret)
            <div class="mt-4 p-4 bg-[var(--brand-tint-3)] dark:bg-[var(--brand)]/10 border border-[var(--brand-tint-2)] dark:border-[var(--brand)]/30 flex flex-wrap items-center justify-between gap-3">
