...
@else
    <span class="{{ $textClass ?? 'text-[21px]' }} font-extrabold tracking-tight text-slate-900 dark:text-white">{{ $base }}<span class="font-medium text-[var(--brand-strong)] dark:text-[var(--brand-light)]">{{ $suffix }}</span></span>
@endif
