@php
    ...
    $aiBtn = 'h-9 px-3 text-xs font-semibold rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 hover:border-[#2E7856] hover:text-[#1F513A] dark:hover:text-[#6FB393] transition inline-flex items-center gap-1.5';
@endphp
    ...
    <div class="panel-card p-6 space-y-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <button type="button" data-ai-action="meta_title" data-ai-target="[name=&quot;meta_title&quot;]" class="{{ $aiBtn }}">
                <svg class="w-3.5 h-3.5 shrink-0 text-[#2E7856] dark:text-[#6FB393]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z"/></svg>
                Meta title</button>
            <button type="button" data-ai-action="meta_description" data-ai-target="[name=&quot;meta_description&quot;]" class="{{ $aiBtn }}">
                <svg class="w-3.5 h-3.5 shrink-0 text-[#2E7856] dark:text-[#6FB393]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 5h18M3 12h18M3 19h10"/></svg>
                Meta description</button>
            <button type="button" data-ai-action="keywords" data-ai-target="[name=&quot;focus_keyword&quot;]" class="{{ $aiBtn }}">
                <svg class="w-3.5 h-3.5 shrink-0 text-[#2E7856] dark:text-[#6FB393]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><path stroke-linecap="round" stroke-linejoin="round" d="m21 21-4.3-4.3"/></svg>
                Focus keyword</button>
            <button type="button" data-ai-action="excerpt" data-ai-target="[name=&quot;excerpt&quot;]" class="{{ $aiBtn }}">
                <svg class="w-3.5 h-3.5 shrink-0 text-[#2E7856] dark:text-[#6FB393]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h8"/></svg>
                Excerpt</button>
            <button type="button" data-ai-action="faq" data-ai-output="#ai-faq-output" class="{{ $aiBtn }}">
                ...
                Suggest FAQ</button>
            <button type="button" data-ai-action="ask" data-ai-question="#ai-ask-input" data-ai-output="#ai-ask-output" class="h-9 px-3 text-xs font-semibold rounded-lg bg-[#2E7856] hover:bg-[#27654A] text-white transition inline-flex items-center gap-1.5">
