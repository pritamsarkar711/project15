            ...
            <nav class="hidden lg:flex items-center gap-1 ml-6 flex-1">
                ...
                <div class="relative">
                    ...
                    <div id="categories-menu" class="hidden absolute left-0 top-full mt-2 w-[480px] max-w-[calc(100vw-2rem)] card-elev shadow-[0_16px_40px_-12px_rgba(15,23,42,0.18)] dark:shadow-black/50 p-2 z-50">
                        ...
                        <a href="/blog" class="flex items-center justify-center gap-1 text-xs font-semibold text-[#049A53] dark:text-emerald-300 hover:text-[#038A4A] py-2.5 mt-1 border-t border-slate-100 dark:border-[#2f2f2f]">View all posts
        ...
        <nav class="p-4 space-y-1">
            ...
            @if(auth()->check())
                @if(auth()->user()->browsingAsUser())
                    ...
                    <a href="{{ route('author.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 hover:bg-[#049A53] rounded-lg text-white font-semibold bg-[#05B762]">
                ...
                @else
                    <a href="{{ auth()->user()->role === 'admin' ? route('admin.dashboard') : route('author.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 hover:bg-[#049A53] rounded-lg text-white font-semibold bg-[#05B762]">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 7h18M3 12h18M3 17h18"/></svg>
