...
<body class="panel-ui min-h-screen bg-slate-100 text-slate-900 dark:bg-[#0f172a] dark:text-slate-100 flex overflow-x-hidden" style="font-family:{{ \App\Support\SiteFont::cssStack() }}">
    ...
    <aside id="admin-sidebar" class="fixed inset-y-0 left-0 w-[250px] bg-slate-900 dark:bg-slate-950 text-slate-300 flex flex-col z-40 transform lg:translate-x-0 -translate-x-full transition-transform duration-300 overflow-y-auto no-scrollbar border-r border-black/30">
        ...
        <nav class="flex-1 p-3 space-y-1 text-sm font-medium">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.dashboard*') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.posts.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.posts.index') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.posts.review-queue') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.posts.review-queue') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.categories.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.categories*') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.pages.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.pages*') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.ads.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.ads*') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.comments.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.comments*') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.contacts.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.contacts*') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.feedback.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.feedback*') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.navigation.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.navigation*') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.profile.edit') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.profile*') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.settings.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.settings.index') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
            ...
            <a href="{{ route('admin.settings.security') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-lg transition {{ request()->routeIs('admin.settings.security') ? 'bg-[#0C3B2E] text-white' : 'hover:bg-white/5 hover:text-white' }}">
        ...
        <div class="p-3 border-t border-white/10">
            <div class="flex items-center gap-3 px-1">
                ...
                @else
                    <div class="w-9 h-9 rounded-full bg-[#05B762] text-white flex items-center justify-center font-bold text-sm">{{ strtoupper(substr(auth()->user()->name,0,1)) }}</div>
                @endif
                ...
                <form method="POST" action="{{ route('admin.logout') }}">@csrf
                    <button type="submit" title="Log out" class="w-8 h-8 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center text-slate-300">
    ...
    <div class="flex-1 lg:ml-[250px] min-w-0 flex flex-col min-h-screen">
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-7">
            ...
            @if(session('success'))
                <div class="mb-4 flex items-center justify-between gap-3 border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-medium text-emerald-800 rounded-xl dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-300">
    ...
    <button id="admin-back-top" type="button" aria-label="Back to top" title="Back to top"
        class="fixed bottom-5 right-5 w-11 h-11 rounded-full bg-[#05B762] hover:bg-[#049A53] dark:bg-emerald-400 dark:hover:bg-emerald-500 dark:text-slate-900 text-white shadow-lg shadow-[#05B762]/30 flex items-center justify-center transition-opacity duration-200 opacity-0 pointer-events-none z-30">
