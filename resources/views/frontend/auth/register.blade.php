...
<div class="max-w-[460px] mx-auto px-4 py-12">
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm rounded-2xl p-7 sm:p-8">
        <div class="text-center mb-7">
            ...
            <h1 class="font-extrabold text-2xl mt-3 text-slate-900 dark:text-white">Create your account</h1>
        ...
        <form method="POST" action="{{ route('register.post') }}" class="space-y-4">
            @csrf
            <div>
                <label class="text-sm font-medium text-slate-900 dark:text-slate-200">Display name</label>
            ...
            <div>
                <label class="text-sm font-medium text-slate-900 dark:text-slate-200">Confirm password</label>
        ...
        <p class="text-sm text-slate-600 dark:text-slate-400 text-center mt-6">
            ...
            <a href="{{ route('login') }}" class="font-semibold text-[#049A53] dark:text-emerald-300 hover:underline">Sign in</a>
        </p>
        <p class="text-[11px] text-slate-500 dark:text-slate-500 text-center mt-3 leading-relaxed">
