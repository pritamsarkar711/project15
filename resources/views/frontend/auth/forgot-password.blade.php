...
<div class="max-w-[460px] mx-auto px-4 py-12">
    <div class="card-elev p-7 sm:p-8">
        ...
        @endif
        @if(session('status'))
            <div class="bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/30 text-emerald-800 dark:text-emerald-300 px-4 py-3 text-sm mb-4 rounded-xl">{{ session('status') }}</div>
        @endif
