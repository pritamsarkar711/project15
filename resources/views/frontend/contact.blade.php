    ...
    <div class="grid lg:grid-cols-12 gap-6 mt-4">
        ...
        <div class="lg:col-span-7">
            <div class="card-elev p-6 sm:p-8">
                ...
                @if(session('success'))<div class="bg-emerald-50 dark:bg-emerald-400/10 border border-emerald-200 dark:border-emerald-400/20 text-emerald-800 dark:text-emerald-300 px-4 py-3 text-sm mb-4 rounded-lg">{{ session('success') }}</div>@endif
