    ...
    <div class="grid lg:grid-cols-12 gap-6">
        <div class="lg:col-span-5">
            ...
            <div class="mt-6 space-y-3 text-sm">
                <div class="flex items-center gap-3 bg-white dark:bg-[#1e1e1e] border border-slate-200 dark:border-[#383838] p-3.5"><span class="w-10 h-10 bg-emerald-50 dark:bg-emerald-400/10 text-[#049A53] dark:text-emerald-300 flex items-center justify-center shrink-0"><svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m22 7-8.5 5.5a4 4 0 0 1-3 0L2 7"/><rect width="20" height="14" x="2" y="5" rx="2"/></svg></span><span><span class="font-semibold text-slate-900 dark:text-white">huvantiofficial@gmail.com</span><br><span class="text-slate-500 dark:text-slate-400">All inquiries — feedback, pitches &amp; corrections</span></span></div>
