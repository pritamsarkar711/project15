...
<div class="max-w-[1200px] mx-auto px-4 sm:px-6 py-8">
    ...
    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        @empty
            <div class="col-span-3 text-center py-12 card-elev"><p class="text-slate-500 dark:text-slate-400">No results. Try another keyword.</p><a href="/" class="mt-4 inline-flex h-10 px-6 bg-[#0C3B2E] hover:bg-[#072A20] text-white text-sm font-semibold items-center transition">Go home</a></div>
        @endforelse
    </div>
