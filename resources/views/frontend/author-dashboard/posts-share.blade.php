...
<div class="max-w-3xl mx-auto space-y-5">
    ...
    <div class="flex gap-3 justify-center pb-2">
        ...
        <a href="{{ route('author.posts.create') }}" class="h-10 px-5 inline-flex items-center rounded-lg bg-[var(--brand)] hover:bg-[var(--brand-strong)] text-white font-semibold text-sm transition">Write another post</a>
    </div>
</div>
