            ...
            <div class="flex items-center gap-2 sm:gap-3">
                ...
                @if(auth()->check() && auth()->user()->browsingAsUser())
                    <form method="POST" action="{{ route('switch-back-to-admin') }}" class="inline">
                        @csrf
                        <button type="submit" title="Return to the admin panel" aria-label="Switch to Admin" class="inline-flex items-center justify-center gap-2 h-9 px-3 sm:px-4 text-sm font-semibold bg-[#05B762] hover:bg-[#049A53] rounded-lg text-white transition cursor-pointer">
                ...
                <a href="{{ url('/') }}" class="inline-flex items-center justify-center gap-2 h-9 px-3 sm:px-4 text-sm font-semibold text-white bg-[#05B762] hover:bg-[#049A53] rounded-lg transition" aria-label="View site" title="View site">
