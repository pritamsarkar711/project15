...
<div class="w-full">
    ...
    <form method="POST" action="{{ route('author.feedback.store') }}" class="mt-5 panel-card p-6 space-y-6">
        ...
        <button type="submit" class="w-full sm:w-auto h-11 px-8 rounded-lg bg-[#0C3B2E] hover:bg-[#072A20] text-white font-semibold text-sm inline-flex items-center justify-center gap-2 transition shadow-sm">
