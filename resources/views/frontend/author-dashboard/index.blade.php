        ...
        <div class="panel-card p-5">
            ...
            @if($recent->isEmpty())
                <div class="text-center py-8">
                    ...
                    <a href="{{ route('author.posts.create') }}" class="inline-flex items-center gap-2 mt-4 h-10 px-5 rounded-lg bg-[#0C3B2E] hover:bg-[#072A20] text-white text-sm font-semibold">
