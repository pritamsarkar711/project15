...
@if(! $revenueEnabled)
    <div class="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 mb-6">
        <div class="flex items-center gap-4">
            <div class="w-11 h-11 bg-slate-100 dark:bg-slate-800 text-slate-400 flex items-center justify-center shrink-0">
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    <div class="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5">
        <div class="flex items-center justify-between">
            ...
            <svg class="w-5 h-5 text-emerald-600 dark:text-emerald-300" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
        </div>
        <div class="text-3xl font-extrabold mt-2 text-emerald-600 dark:text-emerald-300">{{ number_format($stats['published']) }}</div>
...
<div class="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 mt-6">
    ...
    <p class="text-xs text-slate-500 dark:text-slate-400 mt-4">Clicks are counted when readers open links inside your affiliate posts. Share only trusted, reputable websites. Links to low quality or unsafe sites lead to post rejection.</p>
</div>
@endsection
