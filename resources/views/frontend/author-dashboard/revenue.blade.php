...
@if(! $revenueEnabled)
    <div class="panel-card p-6 mb-6">
        <div class="flex items-center gap-4">
            <div class="w-11 h-11 bg-[#F0F7F3] dark:bg-[#2E7856]/10 text-[#27654A] dark:text-[#6FB393] flex items-center justify-center shrink-0">
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    <div class="panel-card p-5">
        ...
        <div class="text-3xl font-extrabold mt-2 text-[#27654A] dark:text-[#6FB393]">{{ number_format($stats['published']) }}</div>
