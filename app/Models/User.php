...
class User extends Authenticatable
{
    ...
    public function badgeHtml(): string
    {
        ...
        return match ($type) {
            // Admin: slate chip with amber accents.
            'admin'  => '<span class="inline-flex items-center gap-1 text-[9.5px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-slate-900 text-amber-300 border border-amber-300/40" title="Verified site administrator">'.$seal.'Admin</span>',
            // 100+ published posts: amber chip (authors only).
            'top'    => '<span class="inline-flex items-center gap-1 text-[9.5px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-amber-400 text-amber-950" title="Top author, 100+ published posts">'.$seal.'Top Author</span>',
            // 10+ published posts: emerald chip (authors only).
            default  => '<span class="inline-flex items-center gap-1 text-[9.5px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-emerald-600 text-white" title="Verified author, 10+ published posts">'.$seal.'Author</span>',
        };
    }
