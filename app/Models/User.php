...
class User extends Authenticatable
{
    ...
    public function badgeHtml(): string
    {
        ...
        return match ($type) {
            // Admin: ink chip with signal border (editorial system).
            'admin'  => '<span class="inline-flex items-center gap-1 text-[9px] font-extrabold uppercase tracking-wider px-2 py-1 bg-[#141A16] text-[#F5C445] border border-[#F5C445]" title="Verified site administrator">'.$seal.'Admin</span>',
            // 100+ published posts: yellow chip (authors only).
            'top'    => '<span class="inline-flex items-center gap-1 text-[9px] font-extrabold uppercase tracking-wider px-2 py-1 bg-[#F5C445] text-[#141A16]" title="Top author, 100+ published posts">'.$seal.'Top Author</span>',
            // 10+ published posts: emerald chip (authors only).
            default  => '<span class="inline-flex items-center gap-1 text-[9px] font-extrabold uppercase tracking-wider px-2 py-1 bg-[#0C3B2E] text-white" title="Verified author, 10+ published posts">'.$seal.'Author</span>',
        };
    }
